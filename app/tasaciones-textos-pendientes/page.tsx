    ...
    <main className="min-h-screen bg-[#f7f7f5] px-5 py-6 lg:px-8 lg:py-8">
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <p className="text-xs font-bold uppercase tracking-[.16em] text-[#c80000]">Fase 1 · Seguimiento</p>
        ...
        <section className="mt-6 rounded-2xl border border-slate-200 bg-white border border-slate-200 p-5 text-white shadow-sm"><div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between"><div><p className="text-[10px] font-bold uppercase tracking-[0.16em] text-slate-400">Bandeja de seguimiento</p><p className="mt-1 text-sm font-semibold">Aquí se encadena tasación aprobada → texto → publicación.</p></div><span className="rounded-full border border-emerald-300/20 bg-emerald-300/10 px-3 py-1.5 text-xs font-bold text-emerald-200">{listos.length} listos para publicar</span></div></section>

        <section className="mt-5 grid gap-3 md:grid-cols-3">
          <div className="rounded-2xl border border-[#ead8d8] bg-[#fdf7f7]/80 p-4">
            <div className="flex items-center gap-3"><span className="flex h-9 w-9 items-center justify-center rounded-full bg-[#fdf2f2] text-sm font-bold text-[#c80000]">1</span><div><p className="text-xs font-bold uppercase tracking-wide text-[#c80000]">Tasación</p><p className="text-sm font-semibold text-slate-900">{pendientes.filter(x => x.situacion === "pendiente_tasacion").length} pendientes</p></div></div>
          </div>
          <div className="rounded-2xl border border-[#ead8d8] bg-[#fdf7f7]/80 p-4">
            <div className="flex items-center gap-3"><span className="flex h-9 w-9 items-center justify-center rounded-full bg-[#fdf2f2] text-sm font-bold text-[#c80000]">2</span><div><p className="text-xs font-bold uppercase tracking-wide text-[#c80000]">Texto</p><p className="text-sm font-semibold text-slate-900">{pendientes.filter(x => x.situacion === "aprobado").length} por preparar</p></div></div>
          </div>
          <div className="rounded-2xl border border-[#ead8d8] bg-[#fdf2f2]/80 p-4">
            <div className="flex items-center gap-3"><span className="flex h-9 w-9 items-center justify-center rounded-full bg-emerald-100 text-sm font-bold text-[#c80000]">3</span><div><p className="text-xs font-bold uppercase tracking-wide text-[#c80000]">Publicación</p><p className="text-sm font-semibold text-slate-900">{listos.length} listos para confirmar</p></div></div>
          </div>
        </section>
          ...
          <>
            <section className="mt-7 rounded-2xl border border-slate-200 bg-white shadow-sm">
              <div className="border-b border-slate-200 px-5 py-4">
                <div className="flex items-center gap-3"><span className="flex h-8 w-8 items-center justify-center rounded-full bg-[#fdf2f2] text-xs font-bold text-[#c80000]">1</span><h2 className="font-bold text-slate-900">Tasaciones pendientes</h2></div>
            ...
            <section className="mt-5 rounded-2xl border border-slate-200 bg-white shadow-sm">
              <div className="border-b border-slate-200 px-5 py-4">
                <div className="flex items-center gap-3"><span className="flex h-8 w-8 items-center justify-center rounded-full bg-[#fdf2f2] text-xs font-bold text-[#c80000]">2</span><h2 className="font-bold text-slate-900">Textos de publicación pendientes</h2></div>
            ...
            <section className="mt-5 rounded-2xl border border-slate-200 bg-white shadow-sm">
              <div className="border-b border-slate-200 px-5 py-4">
                <div className="flex items-center gap-3"><span className="flex h-8 w-8 items-center justify-center rounded-full bg-emerald-100 text-xs font-bold text-[#c80000]">3</span><h2 className="font-bold text-slate-900">Listos para publicar</h2></div>
